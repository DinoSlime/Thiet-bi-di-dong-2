// Đây là trang đăng ký của ứng dụng, cho phép người dùng tạo tài khoản mới
...
export default function SignUpScreen() {
  ...
  const handleSignUp = () => {
    ...
    router.back(); 
    // Hoặc dùng router.replace('/(auth)/login') cũng được
  };
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.form}>
        ...
        {/* Nút quay lại Login */}
        <TouchableOpacity onPress={() => router.back()} style={styles.linkConfig}>
